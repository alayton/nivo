...
export default (function() {
    ...
    return compose(
        ...
        setPropTypes(
            ((_setPropTypes = {}),
            (_setPropTypes[srcKey] = PropTypes.object.isRequired),
            (_setPropTypes[valueKey] = PropTypes.oneOfType([
                PropTypes.string,
                PropTypes.func,
            ]).isRequired),
            _setPropTypes)
        ),
        withPropsOnChange([srcKey, valueKey], function(props) {
            var _ref2

            return (
                (_ref2 = {}),
                (_ref2[destKey] = hierarchy(props[srcKey]).sum(getAccessorFor(props[valueKey]))),
                _ref2
            )
        })
    )
