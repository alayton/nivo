...
export default (function() {
    ...
    return compose(
        defaultProps(
            ((_defaultProps = {}),
            (_defaultProps[colorsKey] = defaultColors),
            (_defaultProps[colorByKey] = defaultColorBy),
            _defaultProps)
        ),
        setPropTypes(
            ((_setPropTypes = {}),
            (_setPropTypes[colorsKey] = PropTypes.any.isRequired),
            (_setPropTypes[colorByKey] = PropTypes.oneOfType([PropTypes.string, PropTypes.func])),
            _setPropTypes)
        ),
        withPropsOnChange([colorsKey, colorByKey], function(props) {
            var _ref2

            return (
                (_ref2 = {}),
                (_ref2[destKey] = getColorsGenerator(props[colorsKey], props[colorByKey])),
                _ref2
            )
        })
    )
