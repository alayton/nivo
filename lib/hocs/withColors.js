...
exports.default = function() {
    ...
    return (0, _compose2.default)(
        ...
        (0, _setPropTypes3.default)(
            ((_setPropTypes = {}),
            (_setPropTypes[colorsKey] = _propTypes2.default.any.isRequired),
            (_setPropTypes[colorByKey] = _propTypes2.default.oneOfType([
                _propTypes2.default.string,
                _propTypes2.default.func,
            ])),
            _setPropTypes)
        ),
        (0, _withPropsOnChange2.default)([colorsKey, colorByKey], function(props) {
            var _ref2

            return (
                (_ref2 = {}),
                (_ref2[destKey] = (0, _colors.getColorsGenerator)(
                    props[colorsKey],
                    props[colorByKey]
                )),
                _ref2
