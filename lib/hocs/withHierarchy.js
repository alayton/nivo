...
exports.default = function() {
    ...
    return (0, _compose2.default)(
        (0, _defaultProps3.default)(
            ((_defaultProps = {}), (_defaultProps[valueKey] = valueDefault), _defaultProps)
        ),
        (0, _setPropTypes3.default)(
            ((_setPropTypes = {}),
            (_setPropTypes[srcKey] = _propTypes2.default.object.isRequired),
            (_setPropTypes[valueKey] = _propTypes2.default.oneOfType([
                _propTypes2.default.string,
                _propTypes2.default.func,
            ]).isRequired),
            _setPropTypes)
        ),
        (0, _withPropsOnChange2.default)([srcKey, valueKey], function(props) {
            var _ref2

            return (
                (_ref2 = {}),
                (_ref2[destKey] = (0, _d3Hierarchy.hierarchy)(props[srcKey]).sum(
                    (0, _propertiesConverters.getAccessorFor)(props[valueKey])
                )),
                _ref2
            )
        })
