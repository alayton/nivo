    ...
    return {
        ...
        compute: function compute(_ref4) {
            ...
            var maxWeeks =
                (0, _max3.default)(
                    yearRange.map(function(year) {
                        return (0,
                        _d3Time.timeWeeks)(new Date(year, 0, 1), new Date(year + 1, 0, 1)).length
                    })
                ) + 1
            ...
            yearRange.forEach(function(year, i) {
                ...
                days = days.concat(
                    (0, _d3Time.timeDays)(yearStart, yearEnd).map(function(dayDate) {
                ...
                var yearMonths = (0, _d3Time.timeMonths)(yearStart, yearEnd).map(function(
                    monthDate
                ) {
                    return (0, _assign3.default)(
                        { date: monthDate },
