...
var enhancedSpring = function enhancedSpring(value, config) {
    if (typeof value !== 'number') {
        return {
            ...
            config: config,
            interpolator:
                config && config.interpolator ? config.interpolator : _d3Interpolate.interpolate,
        }
    }
...
var SmartMotion = (function(_PureComponent) {
    ...
    function SmartMotion() {
        ...
        return (
            ...
            (_this.oldValues = {}),
            (_this.newInters = {}),
            (_this.currentStepValues = {}),
            (_this.stepValues = {}),
            (_this.stepInterpolators = {}),
            _temp)),
    ...
    SmartMotion.prototype.render = function render() {
        ...
        for (var key in resolvedStyle) {
            if (
                ...
                resolvedStyle[key] = (0, _reactMotion.spring)(
                    this.stepValues[key],
            ...
            function(values) {
                ...
                for (var _key2 in values) {
                    if (_this2.stepValues[_key2]) {
                        ...
                        var percentage =
                            _this2.currentStepValues[_key2] - _this2.stepValues[_key2] + 1
                        // Save the current value and replace the value in the interpolated object
                        _this2.oldValues[_key2] = newValues[_key2] = _this2.stepInterpolators[
                            _key2
                        ](percentage)
                    }
                }
